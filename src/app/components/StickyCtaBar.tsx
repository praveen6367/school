      ...
      <div className="bg-[#181A20]/95 backdrop-blur-xl text-white border border-white/[0.14] shadow-[0_20px_50px_rgba(0,0,0,0.45)] rounded-full overflow-hidden px-3.5 sm:px-8 py-2 sm:py-4 flex items-center justify-between gap-2 sm:gap-6">
        ...
        <div className="flex items-center gap-2 sm:gap-6 flex-shrink-0">
          ...
          >
            ...
            <span className="hidden sm:inline ml-2 font-medium">+91 9175122265</span>
          </a>
          ...
          <a
            ...
            className="inline-flex items-center justify-center bg-gradient-to-r from-[#2A60E4] to-[#1D4ED8] hover:from-[#1E4DC0] hover:to-[#172554] text-white px-3.5 sm:px-7 py-2 sm:py-3 rounded-full text-xs sm:text-sm font-bold transition-all hover:scale-105 active:scale-95 shadow-md shadow-[#2A60E4]/30 whitespace-nowrap cursor-pointer"
          >
            Enquire Now
          </a>
        </div>
